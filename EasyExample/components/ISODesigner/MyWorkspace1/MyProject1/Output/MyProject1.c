...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_1), TYPEID_MACRO, WORD(16),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(DataMask2), 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 3, WORD(440), WORD(200), WORD(250)
	ID(Macro_2), TYPEID_MACRO, WORD(16),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(DataMask_Home), 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 4, WORD(600), WORD(350), WORD(350)
	...
	ID(Macro_4), TYPEID_MACRO, WORD(8),
		CMD_HIDE_SHOW, ID(Container_Gesamtzaehler), 1, 0xFF, 0xFF, 0xFF, 0xFF,
	...
	ID(Macro_7), TYPEID_MACRO, WORD(8),
		CMD_HIDE_SHOW, ID(Container_Tageszaehler), True, 0xFF, 0xFF, 0xFF, 0xFF,
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 10, 0, 
		...
		XYREF(Button_S2, 394, 13),
		XYREF(Button_S4, 401, 132),
		XYREF(Button_S5, 402, 179),
	ID(DataMask2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 1, 0, 
		XYREF(Button_S3, 382, 432),
	...
	ID(Button_S2), TYPEID_BUTTON, WORD(85), WORD(77), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_S2, -4, -3),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_S3), TYPEID_BUTTON, WORD(98), WORD(49), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_S3, -4, 11),
		MACRO(EV_KEYRELEASE, Macro_2),
	ID(Button_S4), TYPEID_BUTTON, WORD(68), WORD(38), 249, 249, 1, 0, 1, 2, 
		XYREF(OutputString_S4, -4, 5),
		MACRO(EV_KEYPRESS, Macro_6),
		MACRO(EV_KEYRELEASE, Macro_7),
	ID(Button_S5), TYPEID_BUTTON, WORD(67), WORD(40), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_S5, -4, -5),
	...
	ID(OutputString_S2), TYPEID_OUTSTR, WORD(77), WORD(85), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(7), 'W', 'e', 'c', 'h', 's', 'e', 'l', 0,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_S3), TYPEID_OUTSTR, WORD(98), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(6), 'Z', 'u', 'r', 'ü', 'c', 'k', 0,
	ID(OutputString_S4), TYPEID_OUTSTR, WORD(68), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(5), 'F', 'a', 'r', 'b', 'e', 0,
	ID(OutputString_S5), TYPEID_OUTSTR, WORD(54), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(6), 'Z', 'u', 'r', 'ü', 'c', 'k', 0,
