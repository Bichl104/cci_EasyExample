...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(WorkingSet_0), TYPEID_WORKSET, COLOR(187), 1, ID(DataMask_Home), 1, 0, 2,
		...
		'e', 'n',
		'd', 'e',
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(204), ID(SoftKeyMask_Home), 7, 0, 
		...
		XYREF(Button_MinusMinus, 111, 159),
		XYREF(Button_PlusPlus, 207, 159),
	...
	ID(Button_Reset_Tageszaehler), TYPEID_BUTTON, WORD(120), WORD(60), 1, 197, 1, 0, 1, 0, 
		XYREF(OutputString_Reset_Tageszaehler, 0, 0),
	ID(Button_MinusMinus), TYPEID_BUTTON, WORD(80), WORD(80), 1, 2, 1, 0, 1, 0, 
	...
	ID(LinearBargraph_Gesamtzaehler), TYPEID_OUTLINBAR, WORD(60), WORD(180), COLOR_YELLOW, COLOR_RED, 39, 11, 
		WORD(0), WORD(100), ID(NumberVariable_Gesamtzaehler), WORD(0), ID(NumberVariable_Gesamtziel), WORD(0), 0, 
	ID(LinearBargraph_Tageszaehler), TYPEID_OUTLINBAR, WORD(60), WORD(180), COLOR_YELLOW, COLOR_RED, 39, 11, 
	...
	ID(LineAttributes_Border), TYPEID_LINEATTR, COLOR_RED, 2, WORD(65535), 0, 
	ID(FillAttributes_DarkerBG), TYPEID_FILLATTR, 2, COLOR_RED, ID(ID_NULL), 0, 
